...
import {useSetRenewToken, useSetTimeExpiration, useSetToken} from "../../store/authStore.jsx";

const CardExpirationToken = ({ setShowWarning }) => {
    const { logout } = useUserContext(); // Asegúrate de tener la función login en el contexto
