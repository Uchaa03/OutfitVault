...
ItemCard.propTypes = {
  ...
  className: PropTypes.string, // Custom class for styling (optional)
  onClickButton: PropTypes.func.isRequired, // Click event handler for the main button
  onCloseClick: PropTypes.func.isRequired, // Click event handler for the close button
};
