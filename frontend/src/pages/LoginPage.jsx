...
const LoginPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Inicia Sesión - OutfitVault</title>
        <meta name="description" content="Inicia sesión en OutfitVault para acceder a tu armario digital y gestionar tus outfits de manera inteligente." />
        <link rel="canonical" href="https://outfitvault-1.onrender.com/login" />
      </Helmet>
      <main className="forms">
        <section className="forms__section forms__section--login">
          <header className="section__header">
            <h1 className="header__title">Inicia Sesión</h1>
            <NavLink className="header__buttonForm" to="/register">
              Regístrate
            </NavLink>
          </header>
          <Formik
